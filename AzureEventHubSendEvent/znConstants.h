...
enum
{
    ...
    ID_ZN_TXT_HMAC_SIGNATURE_1_INPUT_STRING,
    ID_ZN_TXT_HMAC_SIGNATURE_1,
    ID_ZN_TXT_HMAC_SIGNATURE_1_SIGNED_STRING,
    ID_ZN_BTN_HMAC_SIGNATURE_1_COPY,
    ID_ZN_TXT_HMAC_SIGNATURE_1_AUTHORIZATION_STRING,
    ID_ZN_BTN_HMAC_SIGNATURE_1_AUTHORIZATION_COPY,

    ID_ZN_TXT_HMAC_SIGNATURE_2_INPUT_STRING,
    ID_ZN_TXT_HMAC_SIGNATURE_2,
    ID_ZN_TXT_HMAC_SIGNATURE_2_SIGNED_STRING,
    ID_ZN_BTN_HMAC_SIGNATURE_2_COPY,
    ID_ZN_TXT_HMAC_SIGNATURE_2_AUTHORIZATION_STRING,
    ID_ZN_BTN_HMAC_SIGNATURE_2_AUTHORIZATION_COPY,

    ID_ZN_BTN_HMAC_SIGNATURE_GENERATE,
    ID_ZN_BTN_HMAC_SIGNATURE_CLEAR,
